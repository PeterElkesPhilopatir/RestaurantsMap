...
import com.peter.restaurantsmap.framwork.ui.ads.AppOpenManager
            ...
            AppOpenAd.load(
                ...
                object : AppOpenAd.AppOpenAdLoadCallback() {
                    ...
                    override fun onAdFailedToLoad(loadAdError: LoadAdError) {
                        isLoadingAd = false
                        Log.d("ad", "onAdFailedToLoad: " + loadAdError.message)
                    }
                })
        }
            ...
            appOpenAd!!.setFullScreenContentCallback(
                object : FullScreenContentCallback() {
                    ...
                    override fun onAdFailedToShowFullScreenContent(adError: AdError) {
                        appOpenAd = null
                        isShowingAd = false
                        Log.d("ad", "onAdFailedToShowFullScreenContent: " + adError.message)
